<div class="form-body">
  ...
  <!-- moved to edit page -->
   <div class="row mb-3">
    <div class="col-md-4">
      <img src="{{ isset($data->profile_photo) ? $data->profile_photo:'http://www.placehold.it/600x800/EFEFEF/AAAAAA'}}" alt="" class="img-fluid" style="max-width: 300px; max-height: 400px;"> 
    </div>
    <div class="col-md-4">
      <img src="{{ isset($data->profile_body_photo) ? $data->profile_body_photo:'http://www.placehold.it/600x800/EFEFEF/AAAAAA'}}" alt="" class="img-fluid" style="max-width: 300px; max-height: 400px;"> 
    </div>
    <div class="col-md-4">
      <img src="{{ isset($data->company_card) ? $data->company_card:'http://www.placehold.it/600x800/EFEFEF/AAAAAA' }}" alt="" class="img-fluid" style="max-width: 300px; max-height: 400px;"> 
    </div>
   </div>
    ...
    <div class="row">
      ...
      <div class="form-group col-md-2">
          ...
          <label class="control-label">Date of Birth</label>
              <input class="form-control form-control-inline" size="16" type="text" value="{!! isset($data->dob) ? $data->dob : old('dob') !!}" name="dob" readonly=""/>
          </div>
      </div>
      <!-- end dob -->
    </div>
      ...
      <div class="form-group col-md-2">
          <div class="col-md-12">
            <label class="control-label">Exclusive</label>
             <input type="checkbox" class="form-control" name="exclusive" disabled="" {{ isset($data) && $data->exclusive ? 'checked':'' }}>
          </div>
      </div>
      ...
      <div class="form-group col-md-3">
          <div class="col-md-12">
            <label class="control-label">Agency</label>
             <select class="form-control" name="agency" disabled="">
             <option value="">Select Agency</option>
              @foreach($agencies as $agency)
                <option value="{{ $agency->id }}" {{ (isset($data->agency_id) && ( $agency->id == $data->agency_id ) || (old('agency') == $agency->id)) ? 'selected' : ''}}>{{ ucfirst($agency->name) }} ({{ucfirst($agency->country_name)}})</option>
              @endforeach
             </select>
          </div>
      </div>
            ...
            <label class="control-label">Status</label>
             ...
             <option value="" >Select Status</option>
              @foreach(config('constants.models.status') as $key => $value)
                <option value="{{ $key }}" {!! isset($data) && $key == $data->status ? 'selected' : ''!!}>{{ ucfirst($value) }}</option>
              @endforeach
             </select>
          </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="form-group col-md-3">
          ...
          <label class="control-label">Doc Expire</label>
              <input class="form-control form-control-inline input-medium" size="16" type="text" value="{!! isset($data->doc_expire) ? $data->doc_expire : old('doc_expire') !!}" name="doc_expire" readonly=""/>
          </div>
      </div>
      <!-- end doc_expire -->
    </div>
    ...
    <div class="form-group col-md-2">
         <div class="col-md-12">
           <label class="control-label">Waist (cm)</label>
             <input type="text" class="form-control" name="waist" value="{!! isset($data->waist) ? $data->waist : old('waist') !!}" readonly="">
         </div>
     </div>
    <!-- end waist -->
    <!-- hips -->
    <div class="form-group col-md-2">
         <div class="col-md-12">
           <label class="control-label">Hips (cm)</label>
             <input type="text" class="form-control" name="hips" value="{!! isset($data->hips) ? $data->hips : old('hips') !!}" readonly="">
         </div>
     </div>
    <!-- end hips -->
    <!-- shoes -->
    <div class="form-group col-md-2">
         <div class="col-md-12">
           <label class="control-label">Shoes</label>
             <input type="text" class="form-control" name="shoes" value="{!! isset($data->shoes) ? $data->shoes : old('shoes') !!}" readonly="">
         </div>
     </div>
    <!-- end shoes -->
    <!-- shoulder -->
    <!-- <div class="form-group col-md-2">
         <div class="col-md-12">
           <label class="control-label">Shoulder</label>
             <input type="text" class="form-control" name="shoulder" value="{!! isset($data->shoulder) ? $data->shoulder : old('shoulder') !!}" disabled="">
         </div>
     </div> -->
    <!-- end shoulder -->
    <!-- collar -->
    <!-- <div class="form-group col-md-2">
         <div class="col-md-12">
           <label class="control-label">Collar</label>
             <input type="text" class="form-control" name="collar" value="{!! isset($data->collar) ? $data->collar : old('collar') !!}" disabled="">
         </div>
     </div> -->
    <!-- end collar -->
  </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-9">
                              <div class="input-group input-large date-picker input-daterange">
                                  ...
                                  <input type="text" class="form-control" name="starts_at" required="" readonly="readonly">
                                  <span class="input-group-append input-group-text"> To </span>
                                  <input type="text" class="form-control" name="ends_at" required="" readonly="readonly">
...
<div class="row">
  <div class="col-12">
      <a href="{{ route('models.edit', ['id' => $data->id]) }}" class="btn btn-primary float-right">Edit</a>
      @if(Auth::guard('admin')->user()->role == 1)
      <a href="{{ route('models.destroy', ['id' => $data->id]) }}" class="btn-delete btn btn-danger float-right">Delete</a>
      @endif
  </div>
</div>
