            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> Edit News Clips</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form role="form" method="POST" id="imagesUploadForm" action="{{ route('news.clips.store', $data->id) }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                        ...
                        <div class="col-xs-12">
                            <ul id="sortable">
                                ...
                                <li id="{{ 'order_'.$i->id }}" data-filename="{{ $i->filename }}" class="ui-state-default">
                                    <button type="button" class="close btn-delete-image" data-url="{{ route('news.clips.destroy', $i->id) }}" style="z-index: 10;">
                                        <span aria-hidden="true">&times;</span>
                                        <span class="sr-only">Close</span>
                                     </button>
                                    <video width="100%" controls class="handle">
                                      <source src="{{ asset('storage/uploads/clips/news/'.$i->filename) }}">
    ...
    $(document).ready(function(){
        ...
        $("#sortable").sortable({
            ...
            stop: function() {
                ...
                var url = "{{ route('news.clips.update') }}";
                //sort
