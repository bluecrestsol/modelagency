            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> Edit News Photos</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form role="form" method="POST" id="imagesUploadForm" action="{{ route('news.images.store', $data->id) }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                        ...
                        <div class="col-xs-12">
                            <ul id="sortable">
                                ...
                                <li id="{{ 'order_'.$i->id }}" data-filename="{{ $i->filename }}" class="ui-state-default">
                                    <button type="button" class="close btn-delete-image" data-url="{{ route('news.images.destroy', $i->id) }}">
                                        <span aria-hidden="true">&times;</span>
                                        <span class="sr-only">Close</span>
                                     </button>
                                    <img src="{{ asset('storage/uploads/photos/news/'.$i->filename) }}" class="handle img-responsive">
                                </li>
                                @endforeach
                            </ul>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $("#sortable").sortable({
            ...
            stop: function() {
                ...
                var url = "{{ route('news.images.update') }}";
                //sort
            ...
            bootbox.confirm("Delete this photo?", function(result){
                if(result) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {_method:'DELETE', news_id:"{{ $data->id }}"},
