  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="tax" value="{!! isset($data->tax) ? $data->tax : old('tax') !!}" readonly="">
      </div>
    </div>
    <!-- end tax -->
    <!-- website -->
  ...
  <div class="row">
    ...
    <div class="form-group col-md-4">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="contact_person" value="{!! isset($data->contact_person) ? $data->contact_person : old('contact_person') !!}" readonly="">
      </div>
    </div>
    <!-- end contact person -->
    <!-- Contact email -->
    <div class="form-group col-md-4">
      <div class="col-md-12">
        ...
        <input type="email" class="form-control" name="contact_email" value="{!! isset($data->contact_email) ? $data->contact_email : old('contact_email') !!}" readonly="">
      </div>
    </div>
    <!-- end contact email -->
    <!-- Contact mobile -->
    <div class="form-group col-md-4">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="contact_mobile" value="{!! isset($data->contact_mobile) ? $data->contact_mobile : old('contact_mobile') !!}" readonly="">
      </div>
    </div>
    <!-- end contact mobile -->
  </div>
  ...
  <div class="col-8">
    <div class="tabbable-line">
        ...
        <div class="tab-content">
            <div class="tab-pane active p-3" id="tab_notes">
                  ...
                  <div class="col-8">
                    ...
                    <form action="{{ route('notes.store') }}" method="post">
                      <div class="input-group">
                        ...
                        <input type="hidden" value="1" name="owner">
                ...
                <div class="list-group">
                  ...
                  <div class="row">
                    <div class="col-xs-8 col-xs-offset-2">
                      <a href="#" class="list-group-item col-xs-10">
...
<div class="row">
  <div class="col-12">
      <a href="{{ route('agencies.edit', ['id' => $data->id]) }}" class="btn btn-primary float-right">Edit</a>
      @if(Auth::guard('admin')->user()->role == 1)
      <a href="{{ route('agencies.destroy', ['id' => $data->id]) }}" class="btn-delete btn btn-danger float-right">Delete</a>
      @endif
  </div>
