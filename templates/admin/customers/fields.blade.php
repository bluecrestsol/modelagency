    ...
    <div class="form-group col-md-4">
         <div class="col-md-12">
           <label class="control-label">Contact Person</label>
             <input type="text" class="form-control" name="contact_name" value="{!! isset($data->contact_name) ? $data->contact_name : old('contact_name') !!}">
         </div>
     </div>
    <!-- end contact person -->
    <!-- Contact email -->
...
<div class="row">
  <div class="col-12">
      ...
      <a href="{{ route('customers.index') }}" class="btn btn-secondary float-right">Cancel</a>
  </div>
</div>
